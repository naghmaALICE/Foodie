...
public class SignupFrame_old extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "card payment", "cash on delivery", "net banking", "paytm" }));

        jButton2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Naghma\\Pictures\\C.PNG")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String r=jPasswordField2.getText();
        String pm=(String) jComboBox1.getSelectedItem();
      
        if( ((u.isEmpty() || a.isEmpty()) || p.isEmpty())||m.isEmpty())
        {
            JOptionPane.showInternalMessageDialog(null," please signup ");
        }
        else
        {
              if(p.equals(r))
        ...
        {
            JOptionPane.showInternalMessageDialog(null,"password do not match ");
        }
        }
